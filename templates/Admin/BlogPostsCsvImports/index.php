            ...
            <td class="col-input bca-form-table__input">
                <?php if (!empty($blogOptions)): ?>
                    <span class="bca-select">
                        <select id="js-blog-content-id" class="bca-select__select">
                            <option value="">-- ブログを選択 --</option>
                            <?php foreach ($blogOptions as $id => $label): ?>
                ...
                <?php else: ?>
                    ...
                    <input type="hidden" id="js-blog-content-id" value="0">
                <?php endif; ?>
            </td>
        </tr>
        <tr>
